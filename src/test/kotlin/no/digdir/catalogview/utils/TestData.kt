...
import no.digdir.catalogview.model.SemVer
...
import no.digdir.catalogview.model.Virksomhet
...
val MAPPED_DB_CONCEPT =
    EMPTY_CONCEPT.copy(
        ...
        publicDefinition =
        Definition(
            text = LocalizedStrings(nb = "public nb", nn = "public nn", en = "public en"),
            sourceDescription =
            SourceDescription(
        ...
        Definition(
            ...
            SourceDescription(
                ...
                source =
                listOf(
                    URIText(uri = "https://source1", text = "Source 1"),
                    URIText(uri = "https://source2", text = "Source 2"),
                ),
            ),
        ),
        ...
        listOf(
            Code(
                codeId = "1",
                codeListId = "code-list-1",
                codeLabel = LocalizedStrings(nb = "Kode 1.1", nn = "Kode 1.1", en = "Code 1.1"),
                codeParent = null,
            ),
        ),
        assignedUser =
