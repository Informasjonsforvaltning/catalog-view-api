...
abstract class ApiTestContext {
    ...
    companion object {
        val conceptContainer: KPostgreSQLContainer =
            KPostgreSQLContainer("postgres:16")
                .withDatabaseName("concept_catalog")
                .withUsername("testuser")
                .withPassword("testpassword")

        val adminContainer: KPostgreSQLContainer =
            KPostgreSQLContainer("postgres:16")
        ...
        val elasticContainer: ElasticsearchContainer =
            ElasticsearchContainer("docker.elastic.co/elasticsearch/elasticsearch:8.17.2")
