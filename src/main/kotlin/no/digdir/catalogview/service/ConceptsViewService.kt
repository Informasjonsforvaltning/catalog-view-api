...
class ConceptsViewService(private val conceptViewRepository: ConceptViewRepository) {
    ...
    fun getConcepts(catalogId: String, changedAfter: Instant?, domainCodes: List<String>?): List<Concept> = when {
        changedAfter != null && domainCodes != null -> conceptViewRepository.getByPublisherAndLastChangedAndDomainCodes(
            catalogId,
    ...
    fun getConceptById(catalogId: String, conceptId: String): Concept = conceptViewRepository.findByIdOrNull(conceptId)
