package no.digdir.catalogview.model
...
data class Concept(
    ...
    val internalSeeAlso: List<String>?,
    val conceptRelations: List<ConceptRelation>?,
    val internalConceptRelations: List<ConceptRelation>?,
    val replacedBy: List<String>?,
    val internalReplacedBy: List<String>?,
...
@JsonInclude(JsonInclude.Include.NON_NULL)
data class ListOfLocalizedStrings(val nb: List<String>?, val nn: List<String>?, val en: List<String>?)

@JsonInclude(JsonInclude.Include.NON_NULL)
data class Definition(val text: LocalizedStrings?, val sourceDescription: SourceDescription?)

@JsonInclude(JsonInclude.Include.NON_NULL)
data class SourceDescription(val relationshipWithSource: String?, val source: List<URIText>?)

@JsonInclude(JsonInclude.Include.NON_NULL)
data class URIText(val uri: String?, val text: String?)

@JsonInclude(JsonInclude.Include.NON_NULL)
data class ContactPoint(val email: String?, val telephone: String?)

@JsonInclude(JsonInclude.Include.NON_NULL)
data class User(val name: String?, val email: String?)

@JsonInclude(JsonInclude.Include.NON_NULL)
data class Code(val codeId: String, val codeListId: String, val codeLabel: LocalizedStrings, val codeParent: String?)
...
@JsonInclude(JsonInclude.Include.NON_NULL)
data class ConceptRelation(val relationType: String?, val description: LocalizedStrings?, val relatedConcept: String?)
