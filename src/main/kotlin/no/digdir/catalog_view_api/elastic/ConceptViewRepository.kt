...
interface ConceptViewRepository : ElasticsearchRepository<Concept, String> {
    ...
    @Query("{\"bool\" : {\"filter\" : [{\"term\" : {\"publisher.keyword\" : \"?0\"}}, {\"range\" : {\"lastChanged\": {\"gte\": \"?1\"}}}]}}")
    ...
    @Query("{\"bool\" : {\"filter\" : [{\"term\" : {\"publisher.keyword\" : \"?0\"}}, {\"range\" : {\"lastChanged\": {\"gte\": \"?1\"}}}, {\"terms\" : {\"domainCodes.codeId.keyword\": ?2}}]}}")
